    ...
    def forward(
        ...
        **attn_kwargs: Unpack[AttentionKwargs],
        ...
        if past_key_value_state is not None:
            ...
            attn, affs = self.UA(queries, keys, values, True, 1.3, static_src, static_dest, True, True) ## The last flag toggles AC on/off. Turn to true if OOM is hit for additional memory savings.
