...
class RopeNoScalingImpl:
    ...
    def compute_scaled_freqs(self, device: str, alpha: int):
        ...
        # )
        freqs = torch.tensor([1.0000e+00, 7.2032e-01, 5.1886e-01, 3.7375e-01, 2.6922e-01, 1.9392e-01,
        1.3969e-01, 1.0062e-01, 7.2478e-02, 5.2207e-02, 3.4615e-02, 2.2779e-02,
        1.4856e-02, 9.5830e-03, 6.0975e-03, 3.8121e-03, 2.3281e-03, 1.3760e-03,
        7.7432e-04, 4.0159e-04, 1.7678e-04, 1.2734e-04, 9.1723e-05, 6.6070e-05,
        4.7591e-05, 3.4281e-05, 2.4693e-05, 1.7787e-05, 1.2812e-05, 9.2290e-06,
        6.6479e-06, 4.7886e-06, 3.4493e-06, 2.4846e-06, 1.7897e-06, 1.2892e-06,
        9.2862e-07, 6.6890e-07, 4.8182e-07, 3.4707e-07], device=device)
        return freqs
...
class UnRopeScalingImpl(RopeNoScalingImpl):
    def compute_scaled_freqs(self, device: str, alpha: int):
        ...
        logend = math.log(4*math.pi / 32768)  # 2 cycles in 32k steps
